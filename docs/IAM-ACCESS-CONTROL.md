...
**Implementation:** [backend/src/index.ts](../backend/src/index.ts) lines 1607–1632
...
| `requireAuth` / `requireRole` helpers | [backend/src/index.ts](../backend/src/index.ts) | Lines 1607–1632 |
...
*This document reflects the state of GuardQuote v2.1 as of 2026-03-25.*
